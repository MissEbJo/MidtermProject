...
START TRANSACTION;
USE `fomogaming`;
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`) VALUES (1, 'Horizon Zero Dawn', 'Experience Aloy’s legendary quest to unravel the mysteries of a future Earth ruled by Machines. Use devastating tactical attacks against your prey and explore a majestic open world in this award-winning action RPG!', 2017, 0, 2, 5, 'https://upload.wikimedia.org/wikipedia/en/9/93/Horizon_Zero_Dawn.jpg', 'https://www.youtube.com/watch?v=wzx96gYA8ek&ab_channel=PlayStation', 1, 1, NULL, 1, NULL);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`) VALUES (2, 'Breath of the Wild', 'Breath of the Wild is an action-adventure game set in an open world where players are tasked with exploring the kingdom of Hyrule while controlling Link. ... Link can procure items from the environment, including weapons, food, and other resources. Unlike previous Zelda games, weapons and shields degrade through use.', 2017, 0, 3, 1, 'https://upload.wikimedia.org/wikipedia/en/c/c6/The_Legend_of_Zelda_Breath_of_the_Wild.jpg', 'https://www.youtube.com/watch?v=zw47_q9wbBE&ab_channel=Nintendo', 19, 1, NULL, 1, NULL);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`) VALUES (3, 'Hades', 'Defy the god of the dead as you hack and slash out of the Underworld in this rogue-like dungeon crawler from the creators of Bastion, Transistor, and Pyre.', 2018, 0, 4, NULL, 'https://cdn1.epicgames.com/min/offer/1200x1600-1200x1600-e92fa6b99bb20c9edee19c361b8853b9.jpg', 'https://www.youtube.com/watch?v=91t0ha9x0AE&ab_channel=IGN', NULL, 1, NULL, 1, NULL);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`) VALUES (4, 'Apex Legends', 'Apex Legends is the award-winning, free-to-play Hero shooter from Respawn Entertainment. Master an ever-growing roster of legendary characters with powerful abilities and experience strategic squad play and innovative gameplay in the next evolution of Hero Shooter and Battle Royale.', 2019, 1, 7, NULL, 'https://upload.wikimedia.org/wikipedia/en/d/db/Apex_legends_cover.jpg', 'https://www.youtube.com/watch?v=innmNewjkuk&ab_channel=ApexLegends', NULL, 1, NULL, NULL, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`) VALUES (5, 'Destiny 2', 'Destiny 2 is an action MMO with a single evolving world that you and your friends can join anytime, anywhere, absolutely free.', 2017, 1, 11, 6, 'https://upload.wikimedia.org/wikipedia/en/0/05/Destiny_2_%28artwork%29.jpg', 'https://www.youtube.com/watch?v=hdWkpbPTpmE&ab_channel=Destiny2', 2, 1, NULL, 1, 1);
...
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`) VALUES (7, 'Tom Clancy\'s Ghost Recon', 'Eastern Europe, 2008. War has broken out on the borders of Russia and the fate of the world hangs in the balance. That\'s when the call goes out for the Ghostsan elite handful of specially trained Green Berets, armed with the latest technology and trained to use the deadliest weapons. Their mission: Spearhead the way for a NATO peacekeeping force, and keep the lid on the conflict before it mushrooms... literally.', 2001, 0, 9, 7, 'https://upload.wikimedia.org/wikipedia/en/8/82/Tom_Clancy%27s_Ghost_Recon.jpg', 'https://www.youtube.com/watch?v=TLLWgsg8ztc&ab_channel=GhostViking', 1, 1, NULL, 1, 1);
...
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`) VALUES (22, 'Dark Souls', 'Dark Souls takes place in the fictional kingdom of Lordran, where players assume the role of a cursed undead character who begins a pilgrimage to discover the fate of their kind.', 2011, 0, 19, 14, 'https://upload.wikimedia.org/wikipedia/en/8/8d/Dark_Souls_Cover_Art.jpg', 'https://www.youtube.com/watch?v=9IbPrk-yuts&ab_channel=BandaiNamcoEntertainmentAmerica', 1, 1, NULL, 1, 1);
