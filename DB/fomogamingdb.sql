...
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (6, 'Mega Man', 'Mega Man, known as Rockman in Japan, is a Japanese science fiction video game franchise created by Capcom, starring a series of robot characters each known by the moniker \"Mega Man\".', 1987, 'Single player', 0, 1, 10, 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Mega_Man_logo.svg/2560px-Mega_Man_logo.svg.png', NULL, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (7, 'Tom Clancy\'s Ghost Recon', 'Eastern Europe, 2008. War has broken out on the borders of Russia and the fate of the world hangs in the balance. That\'s when the call goes out for the Ghostsan elite handful of specially trained Green Berets, armed with the latest technology and trained to use the deadliest weapons. Their mission: Spearhead the way for a NATO peacekeeping force, and keep the lid on the conflict before it mushrooms... literally.', 2001, 'Single player, Multiplayer', 0, 9, 7, 'https://upload.wikimedia.org/wikipedia/en/8/82/Tom_Clancy%27s_Ghost_Recon.jpg', 'https://www.youtube.com/watch?v=TLLWgsg8ztc&ab_channel=GhostViking', 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (8, 'John Madden Football', 'Madden NFL (known as John Madden Football until 1994) is an American Football video game series developed by EA Tiburon for EA Sports. It is named after Pro Football Hall Of Fame coach and commentator John Madden, and it has sold more than 250 million copies. It is also the only officially licensed (NFL) video game series, and it has influenced many players and coaches of the physical sport.', 1988, 'Single player, Multiplayer', 0, 6, 11, 'https://upload.wikimedia.org/wikipedia/en/3/3c/John_madden_football.jpg', NULL, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (9, 'Bill Walsh College Football', 'NCAA Football is an American Football video game series series developed by EA Sports in which players control and compete against current Division 1 FBS college football teams. It served as a college football counterpart to the  Madden NFL series. The series began in 1993 with the release of Bill Walsh College Football. EA eventually acquired the licensing rights to the NCAA name and officially rechristened the series with the release of NCAA Football 98', 1993, 'Single player, Multiplayer', 0, 6, 15, 'https://upload.wikimedia.org/wikipedia/en/6/60/Bill_Walsh_College_Football_Coverart.png', NULL, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (10, 'Paper Boy', 'Paperboy is an arcade action game developed and published by Atari Games and Midway Games, and released in 1985. The player takes the role of a paperboy who delivers a fictional newspaper called The Daily Sun along a suburban street on his bicycle. The arcade version of the game featured bike handlebars as the controller.The game was ported to many home systems beginning in 1986.', 1985, 'Single player', 0, 10, 16, 'https://upload.wikimedia.org/wikipedia/en/7/7e/Paperboy_arcadeflyer.png', NULL, NULL);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (11, 'Final Fantasy IX', 'Zidane and the Tantalus Theater Troupe have kidnapped Princess Garnet, the heir of Alexandria. To their surprise, however, the princess herself yearned to escape the castle.\nThrough a series of unusual circumstances, she and her personal guard, Steiner, fall in with Zidane and set out on an incredible journey. Meeting unforgettable characters like Vivi and Quina along the way, they learn about themselves, the secrets of the Crystal, and a malevolent force that threatens to destroy their world.', 2020, 'Single player', 0, 5, 2, 'https://upload.wikimedia.org/wikipedia/en/5/51/Ffixbox.jpg', 'https://www.youtube.com/watch?v=5XRB3bxC47M&ab_channel=PlayStation', 9);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (12, 'My Time At Portia', 'Start a new life in the enchanting town of Portia! Restore your Pa\'s neglected workshop to its former glory by fulfilling commissions, growing crops, raising animals, and befriending the quirky inhabitants of this charming post-apocalyptic land!', 2019, 'Single player', 0, 18, NULL, 'https://cdn.cloudflare.steamstatic.com/steam/apps/666140/header.jpg?t=1636724347', 'https://www.youtube.com/watch?v=nC_8tZCLA4I&ab_channel=PlayStation', NULL);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (13, 'Stardew Valley', 'You\'ve inherited your grandfather\'s old farm plot in Stardew Valley. Armed with hand-me-down tools and a few coins, you set out to begin your new life. Can you learn to live off the land and turn these overgrown fields into a thriving home?', 2016, 'Single player, Multiplayer', 0, 8, NULL, 'https://upload.wikimedia.org/wikipedia/en/f/fd/Logo_of_Stardew_Valley.png', 'https://www.youtube.com/watch?v=ot7uXNQskhs&ab_channel=ConcernedApe', NULL);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (14, 'Mario Party 10', 'Mario Party 10 continues the tradition of the Mario Party series, in which four players, controlled by either human or CPU, compete against each other on a game board by participating in various minigames.', 2015, 'Single player, Multiplayer', 0, 3, 3, 'https://upload.wikimedia.org/wikipedia/en/1/1a/Mario_Party_10_Small_Official_Boxart.png', 'https://www.youtube.com/watch?v=L69Z39bgdU4&ab_channel=Nintendo', 10);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (15, 'Super Smash Bros Wii U', 'non-traditional fighting games where players use different attacks to weaken their opponents and knock them out of an arena. The games are crossover titles that feature characters, items, music, and stages from various Nintendo franchises, as well as from several third-party franchises.', 2014, 'Single player, Multiplayer', 0, 3, 4, 'https://upload.wikimedia.org/wikipedia/en/a/a2/Super_Smash_Bros_for_Wii_U_Box_Art.png', 'https://www.youtube.com/watch?v=xvudMu-5kIU&ab_channel=SuperSmashBros.', 4);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (16, 'Player Unknown Battle Grounds', 'Pubg // Battlegrounds is a player versus player shooter game in which up to one hundred players fight in a battle royale, a type of large-scale last man standing deathmatch where players fight to remain the last alive. Players can choose to enter the match solo, duo, or with a small team of up to four people. The last person or team alive wins the match', 2017, 'Multiplayer', 1, 13, NULL, 'https://upload.wikimedia.org/wikipedia/en/9/9f/Pubgbattlegrounds.png', 'https://www.youtube.com/watch?v=Zi2hMMVpS64&ab_channel=PlayStationEurope', NULL);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (17, 'Overwatch', 'Overwatch is a team-based multiplayer first-person shooter game developed and published by Blizzard Entertainment. Described as a “hero shooter”, Overwatch assigns players into two teams of six, with each player selecting from a large roster of characters, known as “heroes”, with unique abilities.', 2016, 'Multiplayer', 1, 14, NULL, 'https://upload.wikimedia.org/wikipedia/en/5/51/Overwatch_cover_art.jpg', 'https://www.youtube.com/watch?v=FqnKB22pOC0&ab_channel=PlayOverwatch', NULL);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `mode`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`) VALUES (18, 'Starcraft', 'Set in a fictitious future timeline during the 25th century AD in a distant part of the Milky Way galaxy known as the Koprulu Sector, the game revolves around three intelligent species fighting for dominance: the Terrans are humans exiled from Earth who are now skilled at adapting to any situation; the Zerg are a race of insectoid aliens in pursuit of genetic perfection and obsessed with assimilating other races; the Protoss are a humanoid species with advanced technology and psionic abilities who are attempting to preserve their civilization and strict philosophy about their way of life from the Zerg./', 1999, 'Single player, Multiplayer', 0, 14, 12, 'https://upload.wikimedia.org/wikipedia/en/9/93/StarCraft_box_art.jpg', 'https://www.youtube.com/watch?v=H4Z6Rmbtk1k&ab_channel=DarkBoneFTW', 1);
