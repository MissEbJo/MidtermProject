...
START TRANSACTION;
USE `fomogaming`;
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (1, 'Horizon Zero Dawn', 'Experience Aloy’s legendary quest to unravel the mysteries of a future Earth ruled by Machines. Use devastating tactical attacks against your prey and explore a majestic open world in this award-winning action RPG!', 2017, 0, 2, 5, 'https://upload.wikimedia.org/wikipedia/en/9/93/Horizon_Zero_Dawn.jpg', 'https://www.youtube.com/embed/u4-FCsiF5x4', 1, 1, NULL, 1, NULL, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (2, 'Breath of the Wild', 'Breath of the Wild is an action-adventure game set in an open world where players are tasked with exploring the kingdom of Hyrule while controlling Link. ... Link can procure items from the environment, including weapons, food, and other resources. Unlike previous Zelda games, weapons and shields degrade through use.', 2017, 0, 3, 1, 'https://upload.wikimedia.org/wikipedia/en/c/c6/The_Legend_of_Zelda_Breath_of_the_Wild.jpg', ' https://www.youtube.com/embed/zw47_q9wbBE', 19, 1, NULL, 1, NULL, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (3, 'Hades', 'Defy the god of the dead as you hack and slash out of the Underworld in this rogue-like dungeon crawler from the creators of Bastion, Transistor, and Pyre.', 2018, 0, 4, NULL, 'https://cdn1.epicgames.com/min/offer/1200x1600-1200x1600-e92fa6b99bb20c9edee19c361b8853b9.jpg', 'https://www.youtube.com/embed/91t0ha9x0AE', NULL, 1, NULL, 1, NULL, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (4, 'Apex Legends', 'Apex Legends is the award-winning, free-to-play Hero shooter from Respawn Entertainment. Master an ever-growing roster of legendary characters with powerful abilities and experience strategic squad play and innovative gameplay in the next evolution of Hero Shooter and Battle Royale.', 2019, 1, 7, NULL, 'https://upload.wikimedia.org/wikipedia/en/d/db/Apex_legends_cover.jpg', 'https://www.youtube.com/embed/UMJb_mkqynU', NULL, 1, NULL, NULL, 1, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (5, 'Destiny 2', 'Destiny 2 is an action MMO with a single evolving world that you and your friends can join anytime, anywhere, absolutely free.', 2017, 1, 11, 6, 'https://upload.wikimedia.org/wikipedia/en/0/05/Destiny_2_%28artwork%29.jpg', 'https://www.youtube.com/embed/1bkKwhMgI6s', 2, 1, NULL, 1, 1, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (6, 'Mega Man', 'Mega Man, known as Rockman in Japan, is a Japanese science fiction video game franchise created by Capcom, starring a series of robot characters each known by the moniker \"Mega Man\".', 1987, 0, 1, 10, 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Mega_Man_logo.svg/2560px-Mega_Man_logo.svg.png', 'https://www.youtube.com/embed/ftTX6mCnQkU', 1, 1, NULL, 1, NULL, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (7, 'Tom Clancy\'s Ghost Recon', 'Eastern Europe, 2008. War has broken out on the borders of Russia and the fate of the world hangs in the balance. That\'s when the call goes out for the Ghostsan elite handful of specially trained Green Berets, armed with the latest technology and trained to use the deadliest weapons. Their mission: Spearhead the way for a NATO peacekeeping force, and keep the lid on the conflict before it mushrooms... literally.', 2001, 0, 9, 7, 'https://upload.wikimedia.org/wikipedia/en/8/82/Tom_Clancy%27s_Ghost_Recon.jpg', 'https://www.youtube.com/embed/7NewkthNMDE', 1, 1, NULL, 1, 1, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (8, 'John Madden Football', 'Madden NFL (known as John Madden Football until 1994) is an American Football video game series developed by EA Tiburon for EA Sports. It is named after Pro Football Hall Of Fame coach and commentator John Madden, and it has sold more than 250 million copies. It is also the only officially licensed (NFL) video game series, and it has influenced many players and coaches of the physical sport.', 1988, 0, 6, 11, 'https://upload.wikimedia.org/wikipedia/en/3/3c/John_madden_football.jpg', 'https://www.youtube.com/embed/4mReQXp7ByM', 1, 1, NULL, 1, 1, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (9, 'Bill Walsh College Football', 'NCAA Football is an American Football video game series series developed by EA Sports in which players control and compete against current Division 1 FBS college football teams. It served as a college football counterpart to the  Madden NFL series. The series began in 1993 with the release of Bill Walsh College Football. EA eventually acquired the licensing rights to the NCAA name and officially rechristened the series with the release of NCAA Football 98', 1993, 0, 6, 15, 'https://upload.wikimedia.org/wikipedia/en/6/60/Bill_Walsh_College_Football_Coverart.png', 'https://www.youtube.com/embed/ghlQh4rO1b0', 1, 1, NULL, 1, 1, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (10, 'Paper Boy', 'Paperboy is an arcade action game developed and published by Atari Games and Midway Games, and released in 1985. The player takes the role of a paperboy who delivers a fictional newspaper called The Daily Sun along a suburban street on his bicycle. The arcade version of the game featured bike handlebars as the controller.The game was ported to many home systems beginning in 1986.', 1985, 0, 10, 16, 'https://upload.wikimedia.org/wikipedia/en/7/7e/Paperboy_arcadeflyer.png', 'https://www.youtube.com/embed/8i08_NlXzKQ', NULL, 1, NULL, 1, NULL, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (11, 'Final Fantasy IX', 'Zidane and the Tantalus Theater Troupe have kidnapped Princess Garnet, the heir of Alexandria. To their surprise, however, the princess herself yearned to escape the castle.\nThrough a series of unusual circumstances, she and her personal guard, Steiner, fall in with Zidane and set out on an incredible journey. Meeting unforgettable characters like Vivi and Quina along the way, they learn about themselves, the secrets of the Crystal, and a malevolent force that threatens to destroy their world.', 2020, 0, 5, 2, 'https://upload.wikimedia.org/wikipedia/en/5/51/Ffixbox.jpg', 'https://www.youtube.com/embed/OWbzaPqdR_U', 9, 1, NULL, 1, NULL, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (12, 'My Time At Portia', 'Start a new life in the enchanting town of Portia! Restore your Pa\'s neglected workshop to its former glory by fulfilling commissions, growing crops, raising animals, and befriending the quirky inhabitants of this charming post-apocalyptic land!', 2019, 0, 18, NULL, 'https://cdn.cloudflare.steamstatic.com/steam/apps/666140/header.jpg?t=1636724347', 'https://www.youtube.com/embed/nC_8tZCLA4I', NULL, 1, NULL, 1, NULL, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (13, 'Stardew Valley', 'You\'ve inherited your grandfather\'s old farm plot in Stardew Valley. Armed with hand-me-down tools and a few coins, you set out to begin your new life. Can you learn to live off the land and turn these overgrown fields into a thriving home?', 2016, 0, 8, NULL, 'https://upload.wikimedia.org/wikipedia/en/f/fd/Logo_of_Stardew_Valley.png', 'https://www.youtube.com/embed/ot7uXNQskhs', NULL, 1, NULL, 1, 1, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (14, 'Mario Party 10', 'Mario Party 10 continues the tradition of the Mario Party series, in which four players, controlled by either human or CPU, compete against each other on a game board by participating in various minigames.', 2015, 0, 3, 3, 'https://upload.wikimedia.org/wikipedia/en/1/1a/Mario_Party_10_Small_Official_Boxart.png', 'https://www.youtube.com/embed/L69Z39bgdU4', 10, 1, NULL, 1, 1, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (15, 'Super Smash Bros Wii U', 'non-traditional fighting games where players use different attacks to weaken their opponents and knock them out of an arena. The games are crossover titles that feature characters, items, music, and stages from various Nintendo franchises, as well as from several third-party franchises.', 2014, 0, 3, 4, 'https://upload.wikimedia.org/wikipedia/en/a/a2/Super_Smash_Bros_for_Wii_U_Box_Art.png', 'https://www.youtube.com/embed/nb1m_wyB4bM', 4, 1, NULL, 1, 1, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (16, 'Player Unknown Battle Grounds', 'Pubg // Battlegrounds is a player versus player shooter game in which up to one hundred players fight in a battle royale, a type of large-scale last man standing deathmatch where players fight to remain the last alive. Players can choose to enter the match solo, duo, or with a small team of up to four people. The last person or team alive wins the match', 2017, 1, 13, NULL, 'https://upload.wikimedia.org/wikipedia/en/9/9f/Pubgbattlegrounds.png', 'https://www.youtube.com/embed/Zi2hMMVpS64', NULL, 1, NULL, NULL, 1, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (17, 'Overwatch', 'Overwatch is a team-based multiplayer first-person shooter game developed and published by Blizzard Entertainment. Described as a “hero shooter”, Overwatch assigns players into two teams of six, with each player selecting from a large roster of characters, known as “heroes”, with unique abilities.', 2016, 1, 14, NULL, 'https://upload.wikimedia.org/wikipedia/en/5/51/Overwatch_cover_art.jpg', 'https://www.youtube.com/embed/UEYp1RTvllM', NULL, 1, NULL, NULL, 1, 1);
INSERT INTO `video_game` (`id`, `name`, `description`, `release_year`, `cross_platform`, `developer_id`, `series_id`, `image_url`, `trailer_url`, `number_in_series`, `added_by_user`, `when_added`, `singleplayer`, `multiplayer`, `enabled`) VALUES (18, 'Starcraft', 'Set in a fictitious future timeline during the 25th century AD in a distant part of the Milky Way galaxy known as the Koprulu Sector, the game revolves around three intelligent species fighting for dominance: the Terrans are humans exiled from Earth who are now skilled at adapting to any situation; the Zerg are a race of insectoid aliens in pursuit of genetic perfection and obsessed with assimilating other races; the Protoss are a humanoid species with advanced technology and psionic abilities who are attempting to preserve their civilization and strict philosophy about their way of life from the Zerg./', 1999, 0, 14, 12, 'https://upload.wikimedia.org/wikipedia/en/9/93/StarCraft_box_art.jpg', 'https://www.youtube.com/embed/aVtXac6if14', 1, 1, NULL, 1, 1, 1);
...
START TRANSACTION;
USE `fomogaming`;
INSERT INTO `tv_show` (`id`, `title`, `number_seasons`, `release_year`, `description`, `video_game_id`, `series_id`, `imdb_url`, `trailer_url`, `poster_image_url`) VALUES (1, 'THE WITCHER', 2, 2019, 'The witcher Geralt, a mutated monster hunter, struggles to find his place in a world in which people often prove more wicked than beasts.', 21, 8, 'https://www.imdb.com/title/tt5180504/?ref_=nv_sr_srsg_0', 'https://www.youtube.com/embed/ndl1W4ltcmg', 'https://upload.wikimedia.org/wikipedia/en/2/23/The_Witcher_Title_Card.png');
...
START TRANSACTION;
USE `fomogaming`;
INSERT INTO `streaming_service` (`id`, `name`, `image_url`, `website_url`) VALUES (1, 'Netflix', 'https://upload.wikimedia.org/wikipedia/commons/0/08/Netflix_2015_logo.svg', 'https://www.netflix.com/');
INSERT INTO `streaming_service` (`id`, `name`, `image_url`, `website_url`) VALUES (2, 'Prime Video', 'https://upload.wikimedia.org/wikipedia/commons/1/11/Amazon_Prime_Video_logo.svg', 'https://www.amazon.com/Prime-Video/b?node=2676882011');
