...
START TRANSACTION;
USE `fomogaming`;
INSERT INTO `user` (`id`, `username`, `password`, `email`, `profile_picture`, `enabled`, `role`) VALUES (1, 'admin', 'admin', 'email@email.com', 'https://static.wikia.nocookie.net/maplestory/images/c/c3/Mob_Slime.png/revision/latest?cb=20100509042224', 1, NULL);
